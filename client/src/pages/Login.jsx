        ...
        <StyledContainer>
            <StyledFormArea style={{marginLeft:"14cm"}}>
                ...
                <div className='text-center mb-5 alert' style={{background:"lineargradient(120deg, #eff2f5, #fff"}}>
                    ...
                    <StyledTitle size={55} style={{color:"#c62616", textShadow:" gray 0.1em 0.1em 0.2em"}} ><label htmlFor='' className='h3'>Se connecter</label></StyledTitle>
                </div>

                <div style={{marginTop:"-1.6cm"}} className='form-group'>

                    <TextField color='error' size='small' variant="outlined" className="form-control" label="E-mail" value={email} onChange={(e) =>setEmail(e.target.value)} />
                </div><br/>
                ...
                <div className='text-center mt-4'>
                    <Button onClick={handleLogin} style={{borderRadius:"25px", padding:"10px", width:"180px", fontSize:"14px", textDecoration:"none", textAlign:"center", transition:"0.4s ease-in-out"}} variant="contained" color='error' disabled={!email || !password}>Envoyer</Button>
                </div> 
